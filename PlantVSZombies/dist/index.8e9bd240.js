...
class Cell extends _indexTypes.Rectangle {
    constructor(x, y){
        super();
        this.x = x;
        this.y = y;
...
const createGrid = ()=>{
    for(let i = cellSize; i <= canvas.height; i += cellSize)for(let j = 0; j < canvas.width; j += cellSize)gameGrid.push(new Cell(j, i));
};
const handleGameGrid = ()=>{
    for(let i = 0; i < gameGrid.length; i++)gameGrid[i].draw();
};
// * Projectiles
class Projectile extends _indexTypes.Rectangle {
    power = 200;
    speed = 5;
    constructor(x, y){
        super();
...
const handleProjectiles = ()=>{
    Object.values(projectiles).forEach((p, pIndex)=>{
        ...
        if (p.x > canvas.width - cellSize) p.remove();
    });
};
// * Defenders
class Defender extends _indexTypes.Rectangle {
    shooting = false;
    health = 100;
    timer = 0;
    constructor(x, y){
    ...
    update() {
        ...
        this.timer++;
        if (this.timer % 100 === 0) {
            projectiles[projectilesCount] = new Projectile(this.x + cellSize / 2, this.y + cellSize / 2);
            projectilesCount++;
        }
    }
    remove() {
...
canvas.addEventListener("click", (e)=>{
    ...
    if (Object.values(defenders).some((d)=>d.x === gridPosX && d.y === gridPosY
    )) return;
...
// * Enemies
class Enemy extends _indexTypes.Rectangle {
...
function collision(rect1, rect2) {
    ...
    return !(rect1L > rect2R || rect1R < rect2L || rect1T > rect2B || rect1B < rect2T);
}
// * Exec
createGrid();
animate();

},{"./index.types":"fwz05","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fwz05":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3",".":"1jwFz"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["bk4o9","1jwFz"], "1jwFz", "parcelRequire8ad9")
